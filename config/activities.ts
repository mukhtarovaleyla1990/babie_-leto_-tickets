...
export const ACTIVITIES: Activity[] = [
  ...
  },
  {
    ...
    time: "15:00– 16:00",
    description: "Мастер-класс с Лерой Терпуговой.",
    capacity: 30,
    remainingPlaces: 30,
    isActive: true,
    adultAllowed: true,
  ...
  },
  {
    ...
    time: "15:30– 16:30",
    description: "Мастер-класс с Дарьей Васильевой.",
    capacity: 30,
    remainingPlaces: 30,
    isActive: true,
    adultAllowed: true,
  ...
  },
  {
    ...
    time: "в течение дня",
    description: "Свободное участие в программе фестиваля: все дневные и вечерние мастер-классы , опен эйр тренировки и танцы, возможность присоедениться к любой активности в Holdudvar в свободном режиме, зоны отдыха.",
    capacity: 200,
    remainingPlaces: 200,
    isActive: true,
    adultAllowed: true,
