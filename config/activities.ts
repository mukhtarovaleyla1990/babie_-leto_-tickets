...
export const ACTIVITIES: Activity[] = [
  {
    ...
    time: "11:30 – 13:30",
    description: "Занятие с Ольгой Андреевой в бассейне: мастер класс по технике плавания,или вводный урок: адаптация к воде. В стоимость входит аренда дорожки и мастер класс. нужно приобрести входной билет. .",
    capacity: 12,
    remainingPlaces: 12,
    isActive: true,
    adultAllowed: true,
