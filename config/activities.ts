...
export const ACTIVITIES: Activity[] = [
  ...
  },
  {
    ...
    time: "13:15 – 14:00",
    description: "Тренировка в Holdudvar с Ольгой Литвиновой.",
    capacity: 30,
    remainingPlaces: 30,
    isActive: true,
    adultAllowed: true,
  ...
  {
    id: "fitnes next",
    name: "Фитнес тренироска Богиня",
    time: "14:15– 15:00",
    description: "Тренировка в Holdudvar c Ливией Фекете-Сербайло.",
    capacity: 30,
    remainingPlaces: 30,
    isActive: true,
    adultAllowed: true,
  ...
  {
    id: "sambo",
    name: "Боевое Самбо. Показательное выступление. Мастер-класс по самообороне",
    time: "15:00– 16:00",
    description: "Боевое самбо в Holdudvar c Валентином Гудочниковым.",
    capacity: 30,
    remainingPlaces: 30,
    isActive: true,
    adultAllowed: true,
