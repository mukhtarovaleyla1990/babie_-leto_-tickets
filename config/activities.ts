...
export const ACTIVITIES: Activity[] = [
  {
    ...
    time: "11:30 – 13:30",
    description: "Занятие с Ольгой Андреевой в бассейне: мастер класс по технике плавания,или вводный урок: адаптация к воде .",
    capacity: 12,
    remainingPlaces: 12,
    isActive: true,
    adultAllowed: true,
  ...
  },
  {
    ...
    name: "Футбол",
    time: "11:00 – 13:00",
    description: "Дружеские матчи на траве. Команды формируем на месте.",
    capacity: 30,
    remainingPlaces: 18,
    isActive: true,
    adultAllowed: true,
